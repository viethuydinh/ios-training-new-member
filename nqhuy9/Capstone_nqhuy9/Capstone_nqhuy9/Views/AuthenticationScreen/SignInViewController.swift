...
//MARK: -UI
    ...
    @objc func checkErrorUsername() {
        self.errorUsernameLabel.isHidden = self.signInViewModel.emailValidate(email: self.usernameTextField.text)
        self.errorUsernameImage.isHidden = self.signInViewModel.emailValidate(email: self.usernameTextField.text)
    }
    ...
    @objc func checkErrorPassword() {
        self.errorPasswordLabel.isHidden = self.signInViewModel.passwordValidate(password: self.passwordTextField.text)
        self.errorPasswordImage.isHidden = self.signInViewModel.passwordValidate(password: self.passwordTextField.text)
    }
